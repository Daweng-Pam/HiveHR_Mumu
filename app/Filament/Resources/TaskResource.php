...
//                            ->columnSpanFull(),
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return parent::getEloquentQuery()
            // only show the tasks of that are a part of the projects owned by the authenticated user's id
            ->whereHas('project', function (Builder $query) {
                $query->where('company_id', '=', auth()->user()->id);
            });


        // show all the tasks that are a part of the projects owned by the authenticated user's id
