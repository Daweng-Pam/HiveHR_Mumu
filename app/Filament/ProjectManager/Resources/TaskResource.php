...
//                            ->searchable()
                            ...
                            ->options(User::where('role', '=', 2)->where('approved', '=', 1)->where('career_role', '!=', 1)->where('selected_company', '=', auth()->user()->selected_company)->get()->pluck('name', 'id')->toArray())
                            ->required(),
...
//                            ->searchable()
                            ...
                            ->options(Project::where('project_manager_id', '=', auth()->user()->id)->get()->pluck('title', 'id')->toArray())
                            ->required(),
