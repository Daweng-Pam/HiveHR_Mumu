            ...
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                    @auth
                        @if (auth()->user()->role == 1)
                            <a href="{{ url('/company') }}"
                               class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Company Dashboard</a>
                        @elseif (auth()->user()->role == 2 && auth()->user()->career_role != 1)
                            <a href="{{ url('/employee') }}"
                               class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Employee Dashboard</a>
                        @elseif (auth()->user()->role == 2 && auth()->user()->career_role == 1)
                            <a href="{{ url('/project-manager') }}"
                               class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Project Manager Dashboard</a>
                        @endif
